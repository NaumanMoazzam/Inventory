		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					...
					<button class="btn btn-default button1" data-toggle="modal" id="addProductDetailModalBtn" data-target="#DetailProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Product Details </button>
				</div> <!-- /div-action -->			
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Vendor Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="vendorName" name="vendorName">
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT vendor_id, vendor_name, vendor_address, vendor_cell FROM vendor ";
								$result = $connect->query($sql);
...
<!-- Edited Text For Add Product -->
<!-- add product -->
<div class="modal fade" id="DetailProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">

    	<form class="form-horizontal" id="submitProductDetailForm" action="php_action/createProductDetails.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Product</h4>
	      </div>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="brandName" name="brandName">
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT product_id, product_name, (Select vendor_name from vendor where vendor_id = product.vendor_id) FROM product";
								$result = $connect->query($sql);

								while($row = $result->fetch_array()) {
									echo "<option value='".$row[0]."'>".$row[1] . " By " . $row[2] . "</opti	on>";
								} // while
	        ...
	        <div class="form-group">
	        	<label for="barCode" class="col-sm-3 control-label">Bar Code: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="barCode" onmouseover="this.focus();" placeholder="" name="barCode" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	        	 
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createProductDetailBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
                    ...
                    <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editVendorName" name="editVendorName" >
						      	<option value="">~~SELECT~~</option>
						      	<?php 
...
<!--  Updated Code -->
<!--  Updated Code By Taha Danish -->

<!--  Add Product Detail Page Coding and Record Work -->
