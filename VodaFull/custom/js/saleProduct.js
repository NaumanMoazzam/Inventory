			...
			var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+			  				
				'<td>'+
					...
					$.each(response, function(index, value) {
							'<input type="text" name="prName" id="prName'+count+'" value="'+value[0]+'" autocomplete="off" class="form-control" min="1" />';							
						});
					'<input type="text" name="prName" id="prName'+count+'" autocomplete="off" class="form-control" min="1" />'+
				...
				'<td style="padding-left:20px;">'+
					'<div class="form-group">'+
					'<input type="number" name="quantity" id="quantity'+count+'" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />'+
					'</div>'+
				'</td>'+
				'<td style="padding-left:20px;">'+
