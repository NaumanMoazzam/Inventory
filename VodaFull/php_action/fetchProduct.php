...
$sql = "SELECT product.product_id, product.product_name, product.product_image, product.brand_id,
 		...
 		brands.brand_name, categories.categories_name,vendor.vendor_name FROM product 
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    ...
	    <li><a type="button" data-toggle="modal" data-target="#paymentOrderModal" id="paymentOrderModalBtn" onclick="paymentOrder('.$productId.')" > <i class="glyphicon glyphicon-trash"></i> Payment</a></li>       
	  </ul>
	</div>';
